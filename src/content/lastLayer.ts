...
Bring an unsolved corner to URF, then repeat the orientation algorithm until that corner is solved. Turn only the top layer to bring the next unsolved corner to URF, and repeat.
