...
export function setupMovesForWrongDSlotInHoldView(dSlot: WrongDLayerSlotId): Move[] {
...
export function setupMovesForWrongDSlotStorage(dSlot: WrongDLayerSlotId): Move[] {
